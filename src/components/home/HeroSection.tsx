  ...
  return (
    <div className="relative overflow-hidden bg-background py-24 md:py-32">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute w-96 h-96 -bottom-32 -right-32 bg-teal-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute w-96 h-96 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-5 animate-pulse"
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Discover News That{" "}
            <span className="text-transparent bg-linear-to-r from-cyan-400 to-teal-400 bg-clip-text">
              Matters
            </span>
          </motion.h1>
          ...
          >
            Chronicle AI analyzes thousands of sources to bring you intelligent,
            curated news coverage on topics you care about.
          </motion.p>
